...
#this is not a fair game because the expectation of the resulting bankroll is much less than the starting bank
...
############### METHOD ONE ####################################
unfair_game(num_bets = 100000, increase = .01)
mean(replicate(100, unfair_game(num_bets = 100000, increase = .01)))

unfair_game(num_bets = 100000, increase = .02)
mean(replicate(100, unfair_game(num_bets = 100000, increase = .02))

unfair_game(num_bets = 100000, increase = .015)
mean(replicate(100, unfair_game(num_bets = 100000, increase = .015)))

unfair_game(num_bets = 100000, increase = .001)
mean(replicate(100, unfair_game(num_bets = 100000, increase = .001)))

############### METHOD TWO ####################################
increases <- seq(.01,.02, .001)
fair_mean<-rep(NA, length(increases))
for(i in 1:length(increases)) {
fair_mean[i] <- mean(replicate(100, unfair_game(num_bets = 5000, p1 = increases[i])),na.rm=TRUE)
}
#find the place where there is a sign change
fair_mean
...
```{r}
#the game with the optimized starting probability has a smaller variance. 
three_b <- replicate(100, unfair_game(num_bets = 100000, p1 = .489))
boot_ci(three_b)
three_c <- replicate(100, unfair_game(num_bets = 100000, p1 = .48, increase = .125))
boot_ci(three_c)
```
